...
- (void)viewDidAppear:(BOOL)animated {
    ...
    if (![PFUser currentUser]) { // 沒有使用者登入
        ...
        logInViewController.fields = PFLogInFieldsUsernameAndPassword | PFLogInFieldsLogInButton | PFLogInFieldsTwitter | PFLogInFieldsFacebook |PFLogInFieldsSignUpButton | PFLogInFieldsPasswordForgotten;
